    ...
    createSalesInvoice: ['createIngredients',   function(results, cb) {
      ...
      mongoDB.automigrate('SalesInvoice', function(err) {
        ...
        SalesInvoice.create([
          ...
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(25),
            closedAt: new Date().setDate(25),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(26),
            closedAt: new Date().setDate(26),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(27),
            closedAt: new Date().setDate(27),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(35),
            closedAt: new Date().setDate(35),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(36),
            closedAt: new Date().setDate(36),
            state: 'closed',
            total: 392.089,
          },
          {
          ...
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(37),
            closedAt: new Date().setDate(37),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(38),
            closedAt: new Date().setDate(38),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(39),
            closedAt: new Date().setDate(39),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(70),
            closedAt: new Date().setDate(70),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(71),
            closedAt: new Date().setDate(71),
            state: 'closed',
            total: 392.089,
          },
          {
            visitorId: 'Guest',
            openedAt: new Date().setDate(72),
            closedAt: new Date().setDate(72),
            state: 'closed',
            total: 392.089,
          },
